...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1895.392291125018; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2162.0083638347387; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -2228.4358084058945; // x position of the perpendicular encoder (in tick units)
    }
